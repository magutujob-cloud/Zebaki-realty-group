...
import { Building2, LayoutDashboard, Mail, Newspaper, Users } from "lucide-react";
  ...
  return (
    <div className="mb-8 flex flex-wrap items-center justify-between gap-4 rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Serena dashboard</h1>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <Link href="/admin#listings" className="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700">
          <Building2 className="h-4 w-4" />
          Listings
        </Link>
        <Link href="/admin#inquiries" className="inline-flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700">
